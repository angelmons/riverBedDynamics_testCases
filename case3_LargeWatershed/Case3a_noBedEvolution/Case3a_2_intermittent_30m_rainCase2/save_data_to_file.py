...
def save_data (save_data_time_interval, 
    ...
    if (save_data_time_interval <=0) or save_data_now:
        ...
        # Discharge in m3/s
        data_output_path = path.join(output_path, "output4_node_surface_water__discharge.txt")
        q_nodes = of.discharge_mapper(of._q)
        save_data_to_file(data_output_path, t, q_nodes, node_list)
